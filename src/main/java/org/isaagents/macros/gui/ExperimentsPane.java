...
public class ExperimentsPane extends JPanel {
    ...
    private JLabel createRefreshButton() {
        ...
        refreshButton.setAgentTipText("<html>Analyse content.</html>");
    ...
    private JLabel createUnloadButton() {
        ...
        unloadButton.setAgentTipText("<html>Remove content.</html>");
    ...
    private JLabel createLoadButton() {
        ...
        loadButton.setAgentTipText("<html>Add more content.</html>");
